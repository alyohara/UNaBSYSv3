    ...
    <div class="bg-light p-5 rounded">
        @auth
            <form method="post" action="{{ route('cargo.performCoord') }}">
                ...
                <div class="h5 pb-2 mb-4 text-success border-bottom border-success" style="margin-bottom: 0px !important;">
                    Postulante
                </div>
                ...
                <button class="w-100 btn btn-lg btn-primary" type="submit">Renovar</button>
