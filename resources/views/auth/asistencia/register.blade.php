    ...
    <div class="bg-light p-5 rounded">
        @auth
            <form method="post" action="{{ route('asistencia.perform') }}">
                            ...
                            <select class="form-control selectpicker" data-live-search="true" name="profesor_id"
                                ...
                                @foreach($profesores as $profesor)
                                    <option value="{{ $profesor->id }}"
                                            data-tokens="{{ $profesor->name }}">{{ $profesor->name.', '.$profesor->lastname }}</option>
                                @endforeach
                            </select>
                            ...
                            <select class="form-control" name="subject_id" autofocus id="subject_id2" required disabled>
                                ...
                                @foreach($materias as $subject)
                                    <option value="{{ $subject->id }}"
                                            data-tokens="{{ $subject->name }}">{{ $subject->code.' - '.$subject->name }}</option>
                                @endforeach
                            </select>
                ...
                <div class="row">
                    <div class="text-center">
                        <input type="radio" class="btn-check" name="tipo" id="porFecha" autocomplete="off" value="porFecha" checked>
                        <label class="btn btn-outline-primary" for="porFecha">Por Fecha</label>

                        <input type="radio" class="btn-check" name="tipo" id="porPeríodo" autocomplete="off" value="porPeriodo">
                ...
                <div id="dataPeriodo" style="display: none">
                    <div class="h6 pb-2 mb-4 text-success border-bottom border-success" id="porMatBus">
                    ...
                    <div class="row">
                        <div class="form-group form-floating mb-3 col">
                            <input type="date" class="form-control" name="fecha_inicio" id="fecha_inicio" value="{{ old('fecha_inicio') }}"
                                   placeholder="Fecha Desde" required disabled>
<label for="fecha_inicio">Fecha Desde</label>
                        ...
                        <div class="form-group form-floating mb-3 col">
                            <input type="date" class="form-control" name="fecha_fin" id="fecha_fin" value="{{ old('fecha_fin') }}"
                                   placeholder="Fecha Hasta" required disabled>
<label for="fecha_fin">Fecha Hasta</label>
                ...
                <input type="hidden" name="bedel_id" id="bedel_id" value="{{ auth()->id() }}">
