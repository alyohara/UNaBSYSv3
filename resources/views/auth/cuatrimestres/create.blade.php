            ...
            <form method="post" action="{{ route('cuatrimestres.store') }}">
                ...
                @if(isset($last_Cuatrimestre))
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">{{ $last_Cuatrimestre->nombre }}</h5>
                            <p class="card-text">
                ...
                <div style="display: flex; justify-content: space-between;">
                    <div class="form-group form-floating mb-3" style="width: 45%;">
